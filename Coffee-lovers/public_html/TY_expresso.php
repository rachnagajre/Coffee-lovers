...
$filter="WHERE category='Coffee' AND type='Expresso'";
?>
<!DOCTYPE html>
<html>
    <head>
...
?>
        ...
        <aside>
            <h1>Description</h1>
            <p>It is coffee brewed by forcing a small amount of nearly boiling water under pressure through finely ground coffee beans. Espresso is generally thicker than coffee brewed by other methods, has a higher concentration of suspended and dissolved solids, and has crema on top (a foam with a creamy consistency).</p>
        </aside>
        <section>
            <h1>Expresso Coffee</h1>
			<?php
			echo $products_item;
			?>
        </section>
